...
function Header({ navigation }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex basis-0 justify-end gap-6 sm:gap-8 ml-10">
        <ThemeSelector className="relative z-10" />
        <Link href="https://github.com" className="group" aria-label="GitHub">
          <svg className="h-6 w-6 fill-slate-400 group-hover:fill-slate-500 dark:group-hover:fill-slate-300" aria-hidden="true" viewBox="0 0 16 16">
        ...
        <div className="hidden xl:sticky xl:top-[4.5rem] xl:-mr-6 xl:block xl:h-[calc(100vh-4.5rem)] xl:flex-none xl:overflow-y-auto xl:py-16 xl:pr-6">
          <nav aria-labelledby="on-this-page-title" className="w-56">
            {tableOfContents.length > 0 && (
              <>
                <h2 id="on-this-page-title" className="font-display text-md font-medium text-slate-900 dark:text-white">
                  On this page
                </h2>
