...
export function MobileNavigation({ navigation }) {
  ...
  return (
    <>
      ...
      <Dialog open={isOpen} onClose={setIsOpen} className="fixed inset-0 z-50 flex items-start pr-10 overflow-y-auto bg-slate-900/50 backdrop-blur lg:hidden" aria-label="Navigation">
